const tigerImages = {
    img1: {
        path: "./images/tiger/image_part_001.jpg",
    },
    img2: {
        path: "./images/tiger/image_part_002.jpg",
    },
    img3: {
        path: "./images/tiger/image_part_003.jpg",
    },
    img4:{
        path: "./images/tiger/image_part_004.jpg",
    },
...
const loadImagesIntoPuzzle= function () {
    ...
    for (let tigerImage in tigerImages){
   
      newElt = document.createElement("img")
    
      newElt.src = tigerImages[tigerImage].path; 

      newElt.id = tigerImage;
